            ...
            <div class="formulario transform-gpu">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <div class="formulario-filas">
                        ...
                        <div class="formulario-grupo">
                            <label class="text-gray-700 font-semibold">Costo por mesa</label>
                        ...
                        <div class="border p-6 rounded-lg mb-4 bg-gray-50">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="formulario-grupo">
                                    ...
                                    <input type="number" v-model="cantidadMesas[2]" required min="0"
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                                ...
                                <div class="formulario-grupo">
                                    ...
                                    <input type="number" v-model="cantidadMesas[4]" required min="0"
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                                        @input="actualizarMesas" />
                                </div>
                                ...
                                <div class="formulario-grupo">
                                    ...
                                    <input type="number" v-model="cantidadMesas[6]" required min="0"
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                                        @input="actualizarMesas" />
                                </div>
                            </div>
