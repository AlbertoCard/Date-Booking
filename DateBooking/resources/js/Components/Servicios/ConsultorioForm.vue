                    ...
                    <div class="mt-8 border-t pt-8">
                        ...
                        <div v-for="(disponibilidad, index) in formData.disponibilidad" :key="index"
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button v-if="formData.disponibilidad.length > 1" type="button"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="formulario-grupo">
                                    ...
                                    <select v-model="disponibilidad.dias" required
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                                ...
                                <div class="formulario-grupo">
                                    ...
                                    <input type="text" v-model="disponibilidad.hora_inicio" required placeholder="HH:mm"
                                ...
                                <div class="formulario-grupo">
                                    ...
                                    <input type="text" v-model="disponibilidad.hora_fin" required placeholder="HH:mm"
                                        pattern="^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$"
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                                ...
                                <div class="formulario-grupo">
                                    ...
                                    <select v-model="disponibilidad.intervalo" required
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent">
                        ...
                        <button type="button" @click="agregarDisponibilidad"
                        ...
                        <div v-for="(medico, index) in formData.medicos" :key="index"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="formulario-grupo">
                                    ...
                                    <input type="text" v-model="medico.nombre" required
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent" />
                                </div>

                                <div class="formulario-grupo">
                                    <label class="text-gray-700 font-semibold">Especialidad</label>
                                    <input type="text" v-model="medico.especialidad" required
                                        class="transition-all duration-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent" />
                                </div>
                            </div>
                        </div>

                        <button type="button" @click="agregarMedico"
                            class="w-full p-3 bg-gray-100 hover:bg-gray-200 rounded-lg transition-all duration-300 flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4"></path>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        formDataToSend.append('medicos', JSON.stringify(formData.value.medicos));

        const response = await axios.post('/api/servicios/nuevo-consultorio', formDataToSend, {
